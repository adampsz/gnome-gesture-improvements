 ...
 */
function bind_int_value(key: IntegerSettings, settings: GioSettings, builder: GtkBuilder) {
 ...
 */
function bind_combo_box(key: keyof EnumSettings, settings: GioSettings, builder: GtkBuilder) {
