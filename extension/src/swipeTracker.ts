...
export const TouchpadSwipeGesture = GObject.registerClass(
	{
		Properties: {
			...
			orientation: GObject.ParamSpec.enum(
				...
				'orientation',
				GObject.ParamFlags.READWRITE,
				// @ts-expect-error `Clutter.Orientation` is not assignable to `GObject.GType`
				Clutter.Orientation,
	...
	class TouchpadSwipeGesture extends GObject.Object {
		...
		_handleEvent(
			...
			return this._state === TouchpadState.HANDLING ? Clutter.EVENT_STOP : Clutter.EVENT_PROPAGATE;
		}
